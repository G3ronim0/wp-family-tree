...
function bio_data() {
	...
	if (strpos($ftlink, '?') === false) {
		echo '<p><a href="'.$ftlink.'?ancestor='.$post->post_title.'">' . esc_html_( 'click here to view family tree', 'wp-family-tree' ) .'</a>';
	} else {
		echo '<p><a href="'.$ftlink.'&ancestor='.$post->post_title.'">' . esc_html_( 'click here to view family tree', 'wp-family-tree' ) .'</a>';
	}
}
...
function family_tree_edit_page_form()
{
    ...
    <h3><?php esc_html_e( 'Family tree info (optional)', 'wp-family-tree' ); ?></h3>
    <div class="inside">
...
?>
	<tr><td><?php esc_html_e( 'Gender:', 'wp-family-tree' ); ?></td><td>
    <select name="gender" id="gender">
    <option value="" <?php if (empty($gender)) echo "selected=\"selected\""; ?>></option>
    <option value="m" <?php if ($gender == "m") echo "selected=\"selected\""; ?>><?php esc_html_e( 'Male', 'wp-family-tree' ); ?></option>
    <option value="f" <?php if ($gender == "f") echo "selected=\"selected\""; ?>><?php esc_html_e( 'Female', 'wp-family-tree' ); ?></option>
	</select></td></tr>
    <tr><td><?php esc_html_e( 'Born (YYYY-MM-DD):', 'wp-family-tree' ); ?></td><td><input type="text" name="born" value="<?php echo wp_specialchars(get_post_meta($post->ID, 'born', true), true) ?>" id="born" size="80" /></td></tr>
    <tr><td><?php esc_html_e( 'Died (YYYY-MM-DD):', 'wp-family-tree' ); ?></td><td><input type="text" name="died" value="<?php echo wp_specialchars(get_post_meta($post->ID, 'died', true), true) ?>" id="died" size="80" /></td></tr>
    <tr><td><?php esc_html_e( 'Mother:', 'wp-family-tree' ); ?></td><td>
...
?>
    ...
    <tr><td><?php esc_html_e( 'Father:', 'wp-family-tree' ); ?></td><td>
...
?>
    ...
    <tr><td><?php esc_html_e( 'Spouse:', 'wp-family-tree' ); ?></td><td>
